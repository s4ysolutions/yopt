...
data class ProviderDef(
    ...
    companion object {
        val predefined = listOf(
            ProviderDef("openrouter", "OpenRouter", ApiStyle.OPENAI, AuthType.ApiKey("OpenRouter API Key"), "https://openrouter.ai/api"),
            ProviderDef("openai", "OpenAI", ApiStyle.OPENAI, AuthType.ApiKey("OpenAI API Key"), "https://api.openai.com"),
            ProviderDef("google", "Google Gemini", ApiStyle.GEMINI, AuthType.ApiKey("Gemini API Key"), "https://generativelanguage.googleapis.com"),
